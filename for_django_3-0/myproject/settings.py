...
ALLOWED_HOSTS = ["magma.yulab.org","localhost","127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ["https://*.yulab.org/"]
...
STATICFILES_DIRS=( os.path.join(BASE_DIR, 'Results'), os.path.join(BASE_DIR, 'sample_files'), )
MEDIA_URL = '/media/'
