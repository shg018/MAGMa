...
var tmpstr2 = tmpstr[3].split("_peptide_");
...
d3.csv(filename_volcano_plot, function (data) {
    ...
    data.forEach(function (d) {
        ...
        d.Protein = d['Protein'];
        d.AnnotatedSequence = d['AnnotatedSeq'];
        d.Charge = +d['Charge'];
        // d.FileID = d["Fraction"];
        d.numpsms = +d['# PSMs'];
    ...
    var scatter = svg.selectAll("circle")
        ...
        // .on("mouseover", function (d) { tooltip.style("border", "3px solid " + hexcodeScatter(d, FCval, pvalcutoff)); tooltip.html((d.genesymbol + "<br>" + "Protein: " + d.Protein + "<br>" + "# PSMs: " + d.numpsms + "<br>log2FC: " + (d.log2FC).toFixed(2) + "<br>P-value: " + Number.parseFloat(d.pval).toExponential(2) + "<br>Adj.P-value: " + Number.parseFloat(d.adjpval).toExponential(2) + "<br>Annotated Sequence: " + d.AnnotatedSequence + "<br>Charge: " + d.Charge + "<br>File ID:" + d.FileID)); tooltip.style("top", (event.pageY - d.neglogpval + 3) + "px"); tooltip.style("left", (event.pageX - d.log2FC + 3) + "px"); return tooltip.style("visibility", "visible"); })
        .on("mouseover", function (d) { tooltip.style("border", "3px solid " + hexcodeScatter(d, FCval, pvalcutoff)); tooltip.html((d.genesymbol + "<br>" + "Protein: " + d.Protein + "<br>" + "# PSMs: " + d.numpsms + "<br>log2FC: " + (d.log2FC).toFixed(2) + "<br>P-value: " + Number.parseFloat(d.pval).toExponential(2) + "<br>Adj.P-value: " + Number.parseFloat(d.adjpval).toExponential(2) + "<br>Annotated Sequence: " + d.AnnotatedSequence + "<br>Charge: " + d.Charge)); tooltip.style("top", (event.pageY - d.neglogpval + 3) + "px"); tooltip.style("left", (event.pageX - d.log2FC + 3) + "px"); return tooltip.style("visibility", "visible"); })
